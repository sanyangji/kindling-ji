...
void do_inspect(sinsp *inspector, sinsp_evt_formatter *formatter, int pid, publisher* pub, Profiler *prof, LogCache *log) {
    int32_t res;
    sinsp_evt *ev;
    string line;
...
int main(int argc, char** argv) {
    ...
    try {
        ...
        thread inspect(do_inspect, inspector, &formatter, pid, pub, prof, log);
